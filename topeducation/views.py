...
def mx_magic_link_refresh(request):
    ...
    if selected_plan == "free":
    ...
    elif selected_paid_plan:
        plan_value = selected_paid_plan
        ...
        plan_value = (
            f"{interval}_{selected_plan}"
        )

    else:
        plan_value = (
            f"monthly_{selected_plan}"
        )
    ...
    mx_user_id = str(
        ...
        or response_data.get("mx_user_id")
