...
class Command(BaseCommand):
    ...
    def assign_university_image(self, university_name):
        # Mantener el mismo diccionario de imágenes de universidades del código original
        university_images = {
            ...
            try:
                with transaction.atomic():
                    ...
                    Certificaciones.objects.create(
                        ...
                        nivel_certificacion="NONE",  # Campo por defecto
                        tiempo_certificacion=row['Horario'],
                        lenguaje_certificacion="NONE",  # Campo por defecto
                        aprendizaje_certificacion=row['Acerca de este curso'],
                        habilidades_certificacion=row['Habilidades que obtendrás'],
                        experiencia_certificacion="NONE",  # Campo por defecto
                        contenido_certificacion=row['Programa de estudios'],
                        modulos_certificacion="NONE",  # Campo por defecto
                        testimonios_certificacion=row['Testimonios'],
                        universidad_certificacion=certification_university,
                        empresa_certificacion=str(enterprise_id),  # Convertir a string ya que el modelo espera CharField
